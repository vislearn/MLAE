...
def load_dataset(kind: str, **kwargs) -> TrainValTest:
    if kind in ["miniboone", "gas", "hepmass", "power"]:
        ...
        return get_tabular_datasets(name=kind, data_root='data')
    elif kind == "mnist":
        ...
        return get_latent_datasets(kind, **kwargs)
